...
mx0<-read.csv("201115COVID19MEXICO.csv",sep=",",header=T)
object.size(mx0)/10^6
mx1<-read.csv.ffdf(file="201115COVID19MEXICO.csv",sep=",",header=T,
                   first.rows=-1,colClasses=NA,VERBOSE=T)

object.size(mx0)/10^6
object.size(mx1)/10^6
