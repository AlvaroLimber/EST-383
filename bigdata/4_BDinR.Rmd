# Big Data en R (Descubriendo el poder dentro de R)
...
### Transformacion y agregacion de datos con la libraria ff y ffbase 
...
## Aumento del rendimiento de R con la libreria data.table y otras herramientas
